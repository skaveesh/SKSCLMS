...
<div class="container">
	...
	<div class="row">
		<h4 align="center">Computer Science Lectures (Year 1)</h4>
		<br />
		<div class="collection">
			<a href="csy1/cpp.php" class="collection-item orange-text text-darken-3">Object Oriented Programming with C++</a>
			<a href="csy1/ct.php" class="collection-item orange-text text-darken-3">Computer Technology</a>
			<a href="csy1/int.php" class="collection-item orange-text text-darken-3">Internet Technology</a>
