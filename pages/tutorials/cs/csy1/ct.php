...
<div class="container">
	...
	<div class="row">
		<h5 align="center">Computer Technology</h5>
		<br />


		<ul>
			<li>
				<!--________________________________CT FILES______________________________________-->
					...
					<!--__________________________________________________CT FILE UPLOAD_________________________________________________________-->
...
//Checking that $ok was not set to 0 by an error
									if ($ok == 0) {
										...
										if (move_uploaded_file($_FILES["uploaded"]['tmp_name'], $target)) {
											echo "";
											echo "<p>The file has been uploaded. If it's not there<a class='btn waves-effect waves-light indigo accent-3' href='ct.php'>Reload<i class='material-icons right'>replay</i></a>to see.</p>";
										} else {
											echo "Sorry, there was a problem uploading your file.";
										}
									}
					...
					<!--_______________________________________________END CT FILE UPLOAD_________________________________________________________-->
					...
					<!--_________________________________________________DELETE PHP______________________________________________________-->
								...
								while (list ($key,$val) = @each ($box)) {
									...
									if(unlink($path)) {echo "Deleted file ";
										...
										$delSucc="<p>The file has been deleted. If it's still there<a class='btn waves-effect waves-light indigo accent-3' href='ct.php'>Reload<i class='material-icons right'>replay</i></a>and check.</p>";
									}
									else{
