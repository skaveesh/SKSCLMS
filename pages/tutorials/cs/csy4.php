...
<div class="navbar-fixed">
    ...
    <nav class="grey darken-3 navbaropacity navbarlogo"  style="font-family: Raleway;">
        <div class="nav-wrapper">
            ...
            <img class="responsive-img navbarlogo hide-on-med-and-down" id="navbarlogo1" src="../../../images/LogoLMS.png" style="margin-left: 1em;" alt="Logo">
...
<div class="container">
    ...
    <div class="row">
        <h4 align="center">Computer Science Lectures (Year 4)</h4>
        <br />
