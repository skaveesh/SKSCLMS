...
<div class="container">
    <div class="row">
      <p style="font-size: 150%; font-weight: 300;">
          This is tutorial page. You can download lecture files by visiting below links.
    </p>
    </div>


                <h4 style="font-weight: 300;">Computer Science</h4>
                <div class="collection center">
                    <br />
                    <a class="waves-effect waves-light btn-large grey darken-3" href="tutorials/cs/csy1.php"><i class="material-icons right">call_made</i>CS Lecs.Year 1</a><br /><br />
                    <a class="waves-effect waves-light btn-large grey darken-3" href="tutorials/cs/csy2.php"><i class="material-icons right">call_made</i>CS Lecs.Year 2</a><br /><br />
                    <a class="waves-effect waves-light btn-large grey darken-3" href="tutorials/cs/csy3.php"><i class="material-icons right">call_made</i>CS Lecs.Year 1</a><br /><br />
                    <a class="waves-effect waves-light btn-large grey darken-3" href="tutorials/cs/csy4.php"><i class="material-icons right">call_made</i>CS Lecs.Year 1</a>
                    <br />
                    <br />
                </div>

                <h4 style="font-weight: 300;">Management Information Systems</h4>
                <div class="collection center">
                    <br />
                    <a class="waves-effect waves-light btn-large grey darken-3" href="tutorials/mis/misy1.php"><i class="material-icons right">call_made</i>MIS Lecs.Year 1</a><br /><br />
                    <a class="waves-effect waves-light btn-large grey darken-3" href="tutorials/mis/misy2.php"><i class="material-icons right">call_made</i>MIS Lecs.Year 2</a><br /><br />
                    <a class="waves-effect waves-light btn-large grey darken-3" href="tutorials/mis/misy3.php"><i class="material-icons right">call_made</i>MIS Lecs.Year 3</a><br /><br />
                    <a class="waves-effect waves-light btn-large grey darken-3" href="tutorials/mis/misy4.php"><i class="material-icons right">call_made</i>MIS Lecs.Year 4</a>
                    <br />
                    <br />
                </div>
    </div>
