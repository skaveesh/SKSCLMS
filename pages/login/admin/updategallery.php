...
<div class="navbar-fixed">
    ...
    <nav class="grey darken-3 navbaropacity navbarlogo"  style="font-family: Raleway;">
        <div class="nav-wrapper">
            ...
            <img class="responsive-img n hide-on-med-and-down" id="navbarlogo1" src="../../../images/LogoLMS.png" style="margin-left: 1em;" alt="Logo">
...
<div class="container">
    <div class="row">
        ...
        <div  style="background-color: orangered;border:1px saddlebrown solid; padding: 2em; margin-bottom: 2em; font-size: 110%;">
            ...
            <p><b>NOTE : </b></p>
            <p>Upload Images around 1000px x 600px Resolution.</p>
...
<iframe id="myframe"  src="../../gallery/gallery1.php"  style=" border: 0; margin-top: 3em; margin-bottom: -1.5em; overflow: hidden;" height="550px"></iframe>


<!--Modal Trigger-->
<div class="center" style="margin: 3em; margin-top: 3.5em;">
    <a class="waves-effect waves-light btn modal-trigger indigo accent-3" href = "#modal1">Upload to Gallery</a >
</div>
...
<div class="container">
    ...
    <div class="row center">
        ...
        <div class="col s4 offset-s4">
            ...
            <a class="waves-effect waves-light btn red darken-2" href ="deletefromgallery.php">Delete from Gallery</a >
